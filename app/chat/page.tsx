      ...
      <div style={{ display: "flex", justifyContent: "center", padding: "40px 16px", flex: 1 }}>
        <div
          style={{
            ...
            background: "radial-gradient(circle at top, rgba(56,189,248,0.12), transparent 55%), var(--bg-card)",
            display: "flex",
        ...
        >
          <header style={{ marginBottom: 14 }}>
            ...
            <h1 style={{ fontSize: 20, fontWeight: 700, marginBottom: 6, color: "var(--fg)" }}>
