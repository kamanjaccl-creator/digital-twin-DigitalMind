...
Using the following PRD, generate a comprehensive technical design document
...
The output must be suitable for docs/design.md in a production GitHub repository.
...
> This design was reviewed by the team and optimized for Vercel deployment, security best practices, and scalability.
